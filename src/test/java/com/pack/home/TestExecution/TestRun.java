...
public class TestRun {
	...
	@Test(priority = 23, description="Tries to navigate to Advanced List (passes)")
	...
	@Test(priority = 28, description="Logs out (passes)")
